...
class FootballDriver(NesineScrapper):
    ...
    def __init__(self, url=URL):
        super(FootballDriver, self).__init__()
    ...
    def get_list_of_matches(self):
        try:
            return self.find_elements_until(By.CSS_SELECTOR, "div[class='odd-col event-list pre-event']")
